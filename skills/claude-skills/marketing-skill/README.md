...
**Complete suite of 6 expert marketing skills** for scaling tech companies covering content
creation, demand generation, and product marketing strategy.
...
**Complete Installation Guide:** See [../INSTALLATION.md](../INSTALLATION.md) for detailed
instructions, troubleshooting, and manual installation.

---

## 🎯 Overview

This marketing skills collection provides comprehensive marketing capabilities from content creation
through demand generation and strategic product marketing.
...
**Purpose:** Transform content creation with professional-grade brand voice analysis, SEO
...
- **Brand Voice Analyzer** (`brand_voice_analyzer.py`) - Analyze text for tone, formality, and
  readability
...
- `brand_guidelines.md` - Voice framework with 5 personality archetypes (Expert, Friend, Innovator,
  Guide, Motivator)
- `content_frameworks.md` - 15+ templates (blog posts, email, social, video scripts, case studies)
- `social_media_optimization.md` - Platform-specific guides for LinkedIn, Twitter/X, Instagram,
  Facebook, TikTok
...
**Purpose:** Expert demand generation, paid media, SEO, and partnerships for Series A+ startups
...
**Purpose:** Product marketing, positioning, GTM strategy, and competitive intelligence for product
...
**Content Marketing Role:** → Focus on **content-creator** skill
...
**Demand Generation Role:** → Focus on **marketing-demand-acquisition** skill
...
**Product Marketing Role:** → Focus on **marketing-strategy-pmm** skill
...
**Total Monthly Value: $100,000** **Annual ROI: $1.2M per organization**
...
✅ **Content Creator** - Brand voice, SEO, social media, content frameworks ✅ **Demand &
Acquisition** - Multi-channel campaigns, paid media, SEO, partnerships ✅ **Strategy & PMM** -
Positioning, competitive intel, GTM, launches
...
**Ready to transform your marketing operations!** Start with positioning and ICP (Strategy skill),
build your content engine (Content skill), and scale acquisition (Demand skill). 🚀

For detailed documentation on each skill, see the individual SKILL.md files within each skill
folder.
