...
**Purpose**: Deep SEO analysis and technical optimization **Components**:
...
**Purpose**: Social media campaign management and automation **Components**:
...
**Purpose**: Performance measurement and reporting **Deployed**: February 2026 **Components**:
...
**Purpose**: Email campaign creation and automation **Components**:
...
**Purpose**: PPC campaign optimization **Components**:
...
**Purpose**: Market and competitor analysis **Components**:
...
**Purpose**: CRO and landing page optimization **Components**:
...
**Purpose**: Influencer marketing management **Components**:
...
**Ready to transform your marketing operations?** Start with the content-creator skill and build
from there. Each skill compounds the value of the others, creating a powerful, AI-enhanced marketing
machine.
