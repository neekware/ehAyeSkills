...
This guide covers the 3 production-ready business and growth skills and their Python automation
tools.
...
1. **customer-success-manager/** - Customer health scoring, churn risk analysis, expansion
   opportunities (3 Python tools)
2. **sales-engineer/** - Technical discovery, RFP analysis, competitive positioning, POC planning (3
   Python tools)
3. **revenue-operations/** - Pipeline analysis, forecast accuracy, GTM efficiency metrics (3 Python
   tools)
...
**Last Updated:** February 2026 **Skills Deployed:** 3/3 business & growth skills production-ready
