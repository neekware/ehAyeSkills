...
**Complete suite of 6 world-class Atlassian expert skills** for project and agile delivery teams
...
This project management skills collection provides world-class Atlassian expertise for teams using
Jira and Confluence to deliver software projects and agile initiatives.
...
**Model Context Protocol (MCP)** enables direct integration with Jira and Confluence from Claude
Code.
...
**Learn More:** See [IMPLEMENTATION_SUMMARY.md](IMPLEMENTATION_SUMMARY.md) for MCP integration
details
...
**Last Updated:** January 2026 **Skills Deployed:** 6/6 project management skills production-ready
