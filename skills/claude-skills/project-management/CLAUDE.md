...
This guide covers the 6 production-ready project management skills, 12 Python automation tools, and
...
**Total Tools:** 12 Python automation tools **Agent:** cs-project-manager (orchestrates all 6
skills) **Slash Commands:** 3 (/sprint-health, /project-health, /retro) **Key Feature:** Atlassian
MCP Server integration for direct Jira/Confluence operations
...
**Last Updated:** March 9, 2026 **Skills Deployed:** 6/6 PM skills production-ready **Total Tools:**
12 Python automation tools **Agent:** cs-project-manager | **Commands:** 3 **Integration:**
Atlassian MCP Server for Jira/Confluence automation
